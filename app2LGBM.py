...
symptom_descriptions = {
    ...
    'shivering': 'Involuntary muscle contractions causing trembling.',
    'high_fever': 'Body temperature significantly above normal, typically > 103°F (39.4°C).',
    'mild_fever': 'Slightly elevated body temperature (99.5°F - 102°F).',
    'sweating': 'Excessive perspiration.',
    'weight_loss': 'Decrease in body weight over a period of time.',
    ...
    'altered_sensorium': 'A state of mental confusion or change in awareness.',
    'dizziness': 'Feeling lightheaded or faint.',
    'anxiety': 'A feeling of worry, nervousness, or unease.',
    'mood_swings': 'Rapidly changing emotional states.',
    'headache': 'Pain in the head.',
    'slurred_speech': 'Difficulty articulating words clearly.',
    'loss_of_balance': 'Inability to maintain equilibrium.',
    'neck_pain': 'Ache or discomfort in the neck.',
    'stiff_neck': 'Difficulty moving the neck.',
    'loss_of_smell': 'Inability to perceive odors (Anosmia).',
    'visual_disturbances': 'Problems with sight, such as blurred vision or double vision.',
    'spinning_movements': 'Sensation that the room is spinning (Vertigo).',
    'yellowish_skin': 'Skin turning yellow (Jaundice).',
    'yellowing_of_eyes': 'Yellowing of the whites of the eyes (Scleral icterus).',
    'redness_of_eyes': 'Inflammation or bloodshot eyes.',
    'blurred_and_distorted_vision': 'Lack of visual sharpness.',
    'puffy_face_and_eyes': 'Swelling around the eyes and face.',
    'cough': 'A sudden, forceful expulsion of air from the lungs.',
    'phlegm': 'Thick mucus in the throat or lungs.',
    'continuous_sneezing': 'Frequent, repeated sneezes.',
    'runny_nose': 'Excess mucus draining from the nose.',
    'congestion': 'Nasal blockage or stuffiness.',
    'sinus_pressure': 'Pain or fullness in the facial sinuses.',
    'throat_irritation': 'Soreness or scratchiness in the throat.',
    'patches_in_throat': 'Visible lesions or white spots in the throat.',
    'mucoid_s sputum': 'Clear, thick mucus expelled when coughing.',
    'rusty_sputum': 'Brownish-red sputum, indicating old blood.',
    'blood_in_sputum': 'Expelling blood with cough (Hemoptysis).',
    'breathlessness': 'Difficulty breathing or shortness of breath.',
    'chest_pain': 'Discomfort or tightness in the chest.',
    'fast_heart_rate': 'Abnormally rapid heartbeat (Tachycardia).',
    'palpitations': 'Feeling of a rapid, fluttering, or pounding heart.',
    'itching': 'An uncomfortable, irritating sensation on the skin.',
    'skin_rash': 'Visible eruption on the skin.',
    'nodal_skin_eruptions': 'Small, firm, raised bumps (nodules) under the skin.',
    'pus_filled_pimples': 'Pimples containing pus (Pustules).',
    'blackheads': 'Dark spots on the skin (Comedones).',
    'scurring': 'Skin scarring.',
    'skin_peeling': 'Shedding of the outer layer of skin.',
    'silver_like_dusting': 'Silvery scales on red patches (often Psoriasis).',
    'small_dents_in_nails': 'Pitting of the nails.',
    'blister': 'A small bubble on the skin filled with serum.',
    'red_spots_over_body': 'Small red spots (Petechiae or Purpura).',
    'dischromic_patches': 'Areas of skin with abnormal pigmentation.',
    'internal_itching': 'Itching sensation deep within the body.',
    'bruising': 'Discoloration of the skin resulting from trauma.',
    'stomach_pain': 'Ache or discomfort in the abdominal area.',
    'acidity': 'Heartburn or acid reflux.',
    'vomiting': 'Forcible expulsion of stomach contents.',
    'indigestion': 'Difficulty breaking down food.',
    'nausea': 'Feeling sick to the stomach.',
    'abdominal_pain': 'Pain in the abdomen.',
    'diarrhoea': 'Frequent passage of loose, watery stools.',
    'constipation': 'Infrequent or difficult passage of stool.',
    'pain_during_bowel_movements': 'Discomfort while defecating.',
    'bloody_stool': 'Presence of blood in feces.',
    'irritation_in_anus': 'Itching or burning around the anus.',
    'belly_pain': 'General abdominal discomfort.',
    'stomach_bleeding': 'Gastrointestinal bleeding.',
    'ulcers_on_tongue': 'Open sores on the tongue.',
    'excessive_hunger': 'Abnormal increase in appetite (Polyphagia).',
    'joint_pain': 'Discomfort in joints.',
    'muscle_wasting': 'Loss of muscle tissue.',
    'muscle_weakness': 'Lack of strength in muscles.',
    'painful_walking': 'Pain experienced during walking.',
    'hip_joint_pain': 'Pain originating in the hip joint.',
    'knee_pain': 'Pain or discomfort in the knee.',
    'swelling_joints': 'Enlargement of joints.',
    'movement_stiffness': 'Difficulty moving a joint freely.',
    'back_pain': 'Ache felt in the back.',
    ...
    'spotting_urination': 'Blood present in the urine.',
    'bladder_discomfort': 'Pain or pressure in the bladder area.',
    'foul_smell_of_urine': 'Urine with an unpleasant odor.',
    'continuous_feel_of_urine': 'Frequent or persistent urge to urinate.',
    'polyuria': 'Excessive urination.',
    'yellow_urine': 'Abnormally dark yellow urine.',
...
# --- Load Resources (Using paths from your training scripts) ---

# --- NEW: Paths from your local machine ---
# Use r"..." to create a raw string, which handles Windows backslashes
BASE_DIR = r"C:\Users\sarth\Desktop\Study\Codes\AI_Project"

CNN_MODEL_PATH = os.path.join(BASE_DIR, "models\skin_hybrid_stage_1.keras")
LGBM_MODEL_PATH = os.path.join(BASE_DIR, "models\skin_hybrid_lgbm_model.joblib")

# --- NOTE: This assumes a folder named 'preprocessing_objects' is INSIDE your 'name' directory ---
PREPROCESSOR_DIR = os.path.join(BASE_DIR, 'preprocessing_objects')
CNN_ENCODER_PATH = os.path.join(PREPROCESSOR_DIR, 'label_encoder2.pkl')
CNN_META_ENCODER_PATH = os.path.join(PREPROCESSOR_DIR, 'metadata_encoder2.pkl')
CNN_AGE_SCALER_PATH = os.path.join(PREPROCESSOR_DIR, 'age_scaler2.pkl')

# --- This assumes the symptom models are ALSO in your 'name' directory ---
SYMPTOM_MODEL_PATH = os.path.join(BASE_DIR, 'models\symptom_predictor_model.pkl')
...
def load_all_resources():
    ...
    # --- 1. Load Hybrid LGBM Model Resources (NEW) ---
    try:
        # Load the Keras base model (Stage 1)
        base_cnn_model = tf.keras.models.load_model(CNN_MODEL_PATH, compile=False)
        
        # Create the feature extractor from it (as in your Part 3 script)
        # We trust 'concatenate_6' is the correct layer name from your script
        feature_extractor = tf.keras.Model(
            inputs=base_cnn_model.inputs,
            outputs=base_cnn_model.get_layer('concatenate_6').output,
        )
        resources['feature_extractor'] = feature_extractor
        
        # Load the saved LGBM model
        resources['lgbm_model'] = joblib.load(LGBM_MODEL_PATH)
        
        # Load the preprocessors used for the hybrid model
        ...
        # Get categories from the loaded preprocessors
        ...
        st.error(
            f"⚠️ CRITICAL: Missing Hybrid Model file. "
            "The Image+Metadata mode will not work. Please check paths."
        )
        st.error(f"Attempted to load: {fnf.filename}")
        # Add mock data so the app UI can still load
        resources['lgbm_model'] = None
        resources['feature_extractor'] = None
        resources['cnn_label_encoder'] = None
        resources['cnn_meta_encoder'] = None
        resources['cnn_age_scaler'] = None
        resources['cnn_sex'] = ['male', 'female', 'unknown']
        resources['cnn_sites'] = ['torso', 'head/neck', 'lower extremity', 'unknown']
        resources['cnn_disease_names'] = ['MEL', 'NV', 'BCC', 'AK', 'SCC', 'BKL', 'DF', 'VASC']
    except Exception as e:
        st.error(f"An error occurred loading the Hybrid model resources: {e}")
        st.info("Using mock data for Hybrid model to allow UI to load.")
        resources['lgbm_model'] = None
        resources['feature_extractor'] = None
        resources['cnn_label_encoder'] = None
        resources['cnn_meta_encoder'] = None
    ...
    # --- 2. Load Symptom Model Resources (Unchanged) ---
    try:
        ...
        st.warning(
            f"Symptom-Only Model files not found. (Missing: {fnf.filename}). "
            "Using mock data for this mode."
        )
...
IMG_WIDTH = 256  # Match your training script (Part 1)
IMG_HEIGHT = 256 # Match your training script (Part 1)

@st.cache_data(show_spinner=False)
def predict_hybrid_lgbm(img_data, metadata):
    # Check if models loaded successfully
    if not RESOURCES['feature_extractor'] or not RESOURCES['lgbm_model']:
        st.error("Hybrid LGBM model or feature extractor is not loaded. Cannot predict.")
        # Return mock failure
        mock_encoder = OneHotEncoder() 
        mock_encoder.classes_ = np.array(RESOURCES['cnn_disease_names'])
        mock_probs = np.zeros(len(RESOURCES['cnn_disease_names']))
        mock_probs[0] = 1.0
        return {'probs': mock_probs, 'encoder': mock_encoder, 'mode': 'LGBM-Hybrid'}
    ...
    # Scaling and encoding logic
    age_scaled = RESOURCES['cnn_age_scaler'].transform(
        np.array([[metadata['age_approx']]]).reshape(-1, 1)
    )[0, 0]
    cat_raw_values = np.array(
        [[metadata['sex'], metadata['anatom_site_general']]]
    )
    # Handle potential sparse output from OneHotEncoder
    ...
    if hasattr(cat_encoded, "toarray"):
        ...
        cat_encoded_array = cat_encoded
    
    meta_array = np.concatenate([[age_scaled], cat_encoded_array[0]])
    
    # --- THIS IS THE FIXED LINE ---
    # Ensure correct dtype using tf.cast() instead of .astype()
    meta_tensor = tf.cast(tf.expand_dims(meta_array, axis=0), dtype=tf.float32) 
    
    # --- 3. Extract Features ---
    # Use the feature extractor (Keras model) to get features
    features = RESOURCES['feature_extractor'].predict(
        [img_tensor, meta_tensor], verbose=0
    )
    
    # --- 4. Predict with LGBM ---
    # Use the LGBM model to get probabilities from the features
    pred_probs = RESOURCES['lgbm_model'].predict_proba(features)[0]

    return {
        'probs': pred_probs,
        'encoder': RESOURCES['cnn_label_encoder'], # Use the same label encoder
        'mode': 'LGBM-Hybrid',
    }
...
def predict_symptom_only(user_symptoms_state):
    ...
    if RESOURCES['symptom_model'] is None:
        if sum(user_symptoms_state.values()) < 3:
            mock_disease = 'Common Cold'
        elif (
            'high_fever' in user_symptoms_state
            and user_symptoms_state['high_fever'] == 1
        ):
            mock_disease = 'Pneumonia'
        elif 'itching' in user_symptoms_state and user_symptoms_state['itching'] == 1:
            mock_disease = 'Fungal infection'
        else:
            mock_disease = 'Hypothyroidism'
    ...
    return {
        'disease': RESOURCES['symptom_encoder'].inverse_transform([pred_encoded])[0],
        'probs': pred_probs,
        'encoder': RESOURCES['symptom_encoder'],
        'mode': 'Symptom',
    }
...
if 'user_symptoms_state' not in st.session_state:
    st.session_state.user_symptoms_state = {
        sym: 0 for sym in RESOURCES['symptom_names']
    }
if 'cnn_metadata_state' not in st.session_state:
    st.session_state.cnn_metadata_state = {
        'age_approx': 45.0,
        'sex': 'unknown',
...
try:
    # This assumes you have a .streamlit/secrets.toml file with your key
...
def persistent_help_bot():
    ...
    with st.sidebar:
        ...
        st.caption(
            "Powered by Google Gemini. Please ask brief, general questions."
        )
            ...
            if not client:
                ...
                with st.spinner("Gemini is thinking..."):
                    try:
                        ...
                        gemini_response = (
                            f"**An unexpected Python error occurred:** {e}"
                        )
...
if st.session_state.page == 'home':
    ...
    st.info(
        "Your AI Health Companion — assisting early awareness and guidance. **(See the 🤖 icon/sidebar to chat with the Gemini Health Assistant!)**"
    )

    st.markdown(
        "Predict potential health conditions based on symptoms or by analyzing a skin image."
    )
    st.warning(
        "Remember: This tool provides **preliminary insights** and is **not a substitute for professional medical advice**.",
        icon="⚠️",
    )
    st.divider()
    ...
    with col1:
        if st.button(
            "Use Symptoms Only 📝", type="secondary", use_container_width=True
        ):
            st.session_state.prediction_mode = "symptoms_only"
            nav("input")
    with col2:
        if st.button(
            "Skin Image + Metadata 🖼️",
            type="secondary",
    ...
    if st.session_state.prediction_mode == "symptoms_only":
        ...
        # Check if disease names loaded, otherwise show a generic message
        if RESOURCES['cnn_disease_names']:
            st.markdown(
                f"**This mode checks for the 8 major skin conditions:** {', '.join(RESOURCES['cnn_disease_names'])}."
            )
        else:
            st.markdown(
                "**This mode checks for 8 major skin conditions.**"
            )
    ...
    if st.session_state.prediction_mode == "image+meta":
        ...
        with col_img:
            with st.container(border=True):
                ...
                uploaded_file = st.file_uploader(
                    ...
                    help="Upload a clear image of the lesion.",
                )
                if uploaded_file:
                    st.session_state.cnn_metadata_state[
                        'uploaded_image'
        ...
        with col_meta:
            with st.container(border=True):
                ...
                age_value = int(
                    st.session_state.cnn_metadata_state['age_approx']
                )
                age = st.number_input(
                    "Approximate Age:",
                    min_value=0,
                ...
                options_sex = sorted(
                    [s for s in RESOURCES['cnn_sex'] if s != 'unknown']
                ) + ['unknown']
                sex = st.radio(
                    "Sex:",
                    options=options_sex,
                    index=options_sex.index(
                        st.session_state.cnn_metadata_state['sex']
                    ),
                    horizontal=True,
                    key='sex_input',
                )
                ...
                options_site = sorted(
                    [s for s in RESOURCES['cnn_sites'] if s != 'unknown']
                ) + ['unknown']
                site = st.selectbox(
                    "Anatomical Site:",
                    options=options_site,
                    index=options_site.index(
                        st.session_state.cnn_metadata_state[
                            'anatom_site_general'
                        ]
                    ),
                    key='site_input',
                    help="Where is the lesion located on the body? Required for prediction.",
                )
                st.session_state.cnn_metadata_state[
                    'anatom_site_general'
                ] = site

        validation_check = not st.session_state.cnn_metadata_state[
            'uploaded_image'
        ]
        # --- UPDATE: Call the new LGBM function ---
        prediction_func = lambda: predict_hybrid_lgbm(
            st.session_state.cnn_metadata_state['uploaded_image'],
            st.session_state.cnn_metadata_state,
        )
        ...
        with st.container(border=True):
            ...
            st.markdown(
                "Filter symptoms by category or view all. Select all that apply."
            )

            groups_list = ["Show All Symptoms"] + list(symptom_groups.keys())
            selected_group_radio = st.radio(
                "Filter Symptoms:",
                groups_list,
                index=0,
                horizontal=True,
            ...
            items_to_display = (
                RESOURCES['symptom_names']
                if selected_group_radio == "Show All Symptoms"
                else symptom_groups.get(selected_group_radio, [])
            )
                ...
                if s in st.session_state.user_symptoms_state:
                    with cols[checkbox_count % 3]:
                        ...
                        is_checked = st.checkbox(
                            display_name,
                            value=bool(
                                st.session_state.user_symptoms_state[s]
                            ),
                            key=f"cb_{s}",
                            help=symptom_descriptions.get(
                                s,
                                f"Select if you are experiencing: {display_name}",
                            ),
                        )
                        st.session_state.user_symptoms_state[s] = (
        ...
        validation_check = (
            sum(st.session_state.user_symptoms_state.values()) == 0
        )
        prediction_func = lambda: predict_symptom_only(
            st.session_state.user_symptoms_state
        )
    ...
    with col_pred:
        if st.button("▶️ Predict", type="primary", use_container_width=True):
            if validation_check:
                st.error(
                    "⚠️ Please provide the necessary input (Image/Metadata or selected Symptoms)."
                )
            elif (
                st.session_state.prediction_mode == "symptoms_only"
                and RESOURCES['symptom_model'] is None
                and sum(st.session_state.user_symptoms_state.values()) == 0
            ):
                st.error(
                    "Symptom-Only Model is not available and no symptoms were selected for mock testing."
                )
            else:
                with st.spinner("Analyzing data..."):
                    try:
                        ...
                        predicted_disease = result_dict['encoder'].classes_[
                            predicted_index
                        ]
                        confidence = (
                            result_dict['probs'][predicted_index] * 100
                        )

                        top_indices = result_dict['probs'].argsort()[-3:][::-1]
                        top_conditions = [
                            (
                                result_dict['encoder'].classes_[i],
                                result_dict['probs'][i] * 100,
                            )
    ...
    with col_back:
        if st.button(
            "⬅️ Back to Options", use_container_width=True, type="secondary"
        ):
            nav("options")
    ...
    if result:
        ...
        # --- UPDATE: Handle the new 'LGBM-Hybrid' mode ---
        if result['mode'] == 'LGBM-Hybrid':
            mode_text = "Skin Image + Metadata Analysis (LGBM Model)"
        else:
            mode_text = "General Symptom Analysis"
        
        # --- Main Result Container (Minimal UI replacement) ---
        with st.container(border=True):
            is_critical = main_disease in [
                'MEL',
                'BCC',
                'SCC',
                'Heart attack',
        ...
        # --- Disease Description ---
        description = ALL_DISEASE_DESCRIPTIONS.get(
            main_disease,
            "No specific description is available for this condition. Please consult a doctor for details.",
        )
        st.subheader(f"About {main_disease}")
        st.info(description, icon="💡")

        st.warning(
            "⚠️ **Disclaimer:** This AI prediction is **not a diagnosis**. Consult a healthcare professional for accurate medical advice.",
            icon="ℹ️",
        )
    else:
        st.warning(
            "No prediction result found. Please start a new diagnosis."
        )
    ...
    with col1:
        if st.button(
            "🔄 New Diagnosis", use_container_width=True, type="secondary"
        ):
